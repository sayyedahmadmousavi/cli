...
public final class Example {
	...
	private static final String commandsLine = "Enter command (gcs - GetChats, gc <chatId> - GetChat, me - GetMe, sm <chatId> <message> - SendMessage,dm - DeleteMessage, lo - LogOut, q - Quit): ";
...
//		System.out.println(str);
	...
	private static void onAuthorizationStateUpdated(TdApi.AuthorizationState authorizationState) {
		...
		case TdApi.AuthorizationStateWaitTdlibParameters.CONSTRUCTOR:
			...
			parameters.apiId = 157840;
			parameters.apiHash = "fb312875319b91cb152aa4e4a0231584";
		...
		case TdApi.AuthorizationStateWaitPhoneNumber.CONSTRUCTOR: {
			...
			client.send(new TdApi.SetAuthenticationPhoneNumber(phoneNumber, false, false),
		...
		case TdApi.AuthorizationStateClosed.CONSTRUCTOR:
			...
			break;
		default:
			System.err.println("Unsupported authorization state1:" + newLine + Example.authorizationState + newLine
					+ "Unsupported authorization state2:" + Example.authorizationState);
		}
	}
...
//		System.out.print(prompt);
	...
	private static void getCommand() {
		...
		try {
			...
			case "me":
				...
				break;
			case "dm":
				String[] args1 = commands[1].split(" ", 2);
				long[] mmessagesId = new long[1];
				mmessagesId[0] = toLong(args1[1]);
				client.send(new TdApi.DeleteMessages(toLong(args1[0]), mmessagesId, false), defaultHandler);
				break;
			case "sm": {
	...
	private static void getChatList(final int limit) {
		synchronized (chatList) {
			if (!haveFullChatList && limit > chatList.size()) {
				...
				client.send(new TdApi.GetChats(offsetOrder, offsetChatId, limit - chatList.size()),
	...
	private static void sendMessage(long chatId, String message) {
		...
		TdApi.InputMessageContent content = new TdApi.InputMessageText(new TdApi.FormattedText(message, null), false,
				true);
...
//		}
		...
		// test Client.execute
		defaultHandler.onResult(Client.execute(
